        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-4 mr-auto">
              <p className="lead">Whether you are a student looking to showcase your work, a professional looking to attract clients, or a graphic artist looking to share your projects, this template is the perfect starting point!</p>
            </div>
          </div>
